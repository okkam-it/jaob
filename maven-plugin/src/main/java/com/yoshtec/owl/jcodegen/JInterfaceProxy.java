...
/* package */ class JInterfaceProxy {
  ...
  private static final Logger log = LoggerFactory.getLogger(JInterfaceProxy.class);
  ...
  /**
   * Add a new Property to this Class interface and set the inheritance.
   * 
  ...
  /**
   * Adds the property and delegates it to the implementors of this class / interface.
   * 
  ...
  public void addToImplementors(JInterfaceProxy iface) {
  ...
  /**
   * Rwturns a newly created Interface with this name or the reference to an already existing one.
   */
  ...
  /**
   * Returns the reference to the existent Implementation or a newly created one.
   */
  ...
  public void addImplementation(String javaClassSuffix) {
    ...
    if (this.createInterface) {
      ...
      if (!intersectionOf.isEmpty()) {
        ...
        JAnnotationArrayMember annot =
            iface.annotate(OwlObjectIntersectionOf.class).paramArray("classes");
  ...
  private void annotateJClass(JDefinedClass jclass) {
    ...
    if (!annotations.isEmpty()) {
      JAnnotationArrayMember oannotsarray =
          jclass.annotate(OwlAnnotations.class).paramArray("value");
  ...
  /**
   * If this JInterfaceProxy can be a class on its own. This is the case if this class has none or
   * only one superclass otherwise it has to be an interface.
   */
  ...
  /**
   * Returns whether an interface will be generated {@code true} or not.
   */
  ...
  /**
   * Sets the create interface.
   * 
   * @param createInterface whether an interface shall be generated {@code true} or not
   *        {@code false}
   */
  ...
  /**
   * If this class creates a Interface implementation pair, how the class should be suffixed.
   * Example: OwlClass Name: Apple Suffix: Impl
   * <p>
   * Java Interface Name: Apple Java Class Name: AppleImpl
   * </p>
   * 
   * @param s the Suffix
   */
