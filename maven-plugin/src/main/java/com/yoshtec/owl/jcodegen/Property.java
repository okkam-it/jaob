...
/**
 * Abstraction for OWL Properties. Bridges the OWL Property and Java Field setter/getter world.
 * 
...
/* package */ class Property {
  ...
  /** List of <i>rdfs:comment</i>s as String. */
  ...
  /**
   * Returns the variable name in Java Style.
   */
  public String getJavaStyleVarName() {
    try {
  ...
  /**
   * Adds an Methods, Fields and the Implementation to the JClass if it is a real class, just puts
   * Method stubs if it is an interface.
   * 
  ...
  public void addImplementationTo(JDefinedClass jclass, boolean inheritDoc) {
    ...
    String varName = this.getJavaStyleVarName();
  ...
  /**
   * Returns the JavaDoc string of this Property.
   */
  ...
  /**
   * Returns the boxed type if this Property is functional, a narrowed {@code List<type>} of the
   * type else.
   */
