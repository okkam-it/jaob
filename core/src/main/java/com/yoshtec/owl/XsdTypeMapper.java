...
public class XsdTypeMapper {
	...
	/**
	 * Sets a new or overwrites an existing Mapping from
	 * a {@link XsdType} to a Java class. 
	 * 
	...
	/**
	 * Sets or overwrites an Reverse Mapping from a Java class to 
	 * an {@link XsdType} 
	...
	/**
     * Checks if the URI is from XML Schema and returns the 
