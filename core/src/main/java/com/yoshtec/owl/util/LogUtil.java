...
/**
 * Helps Debugging and retrieve Runtime Information for Java Objects at runtime.
 * 
...
public class LogUtil {
  ...
  /**
   * Logs the contents of an Object to the debug logger. Uses reflection to get all getters and
   * invokes them, logging the result to debug.
   * 
