...
public final class UnMarshaller {
	 ...
	 */
	public Collection<Object> unmarshal(IRI physicalUri) throws UnmarshalException {
...
//			System.out.println("Setting prop "+ prop.propUri+ " for "+ value);
	...
	protected void unmarshall(OWLNamedIndividual oi) throws IllegalArgumentException, InstantiationException, IllegalAccessException, InvocationTargetException {
...
//			System.out.println(myObj);
	...
	private void addDataProperties(OWLIndividual oi, ClassFacade cf, Object instance) {
		Map<OWLDataPropertyExpression, Set<OWLLiteral>> dataPropertyValues = oi.getDataPropertyValues(ontology);
		for( Entry<OWLDataPropertyExpression, Set<OWLLiteral>> dpEntry : dataPropertyValues.entrySet()) {
