...
public class FieldPropertyAccessor implements PropertyAccessor {
  ...
  public FieldPropertyAccessor(Field field, IRI propUri, XmlAdapter<?, ?> adapter,
  ...
  /**
   * Rwturns the Field if this Property is accessed via fields otherwise {@code null}.
   */
