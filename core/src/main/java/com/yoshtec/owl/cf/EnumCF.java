...
class EnumCF<E extends Enum<E>> extends SimpleClassFacade<E> implements ClassFacade  {
    ...
    /** stores the names - Enum value association 
     * the enum value is often different to the vaue of the Enum 
     */
    ...
    EnumCF(Class<E> clazz, XsdTypeMapper typeMapper){
        ...
        classuris.add(ReflectUtil.getClassUri(clazz));
    ...
    @Override
    public E getNewInstance(String id) throws IllegalArgumentException,
