 ...
 * Class URI: <code>http://www.semanticweb.org/vfayet/ontologies/2013/5/untitled-ontology-36#Peer</code>
 * 
 * <br>
 * OWLComment: Represents the peer
 * 
 */
@OwlClass(uri = "http://www.semanticweb.org/vfayet/ontologies/2013/5/untitled-ontology-36#Peer")
@OwlSubclassOf({
    @OwlClass(uri = "http://www.w3.org/2002/07/owl#Thing"),
    @OwlClass(uri = "http://www.semanticweb.org/vfayet/ontologies/2013/5/untitled-ontology-36#Person")
})
@OwlAnnotations({
    @OwlAnnotation(uri = "http://www.w3.org/2000/01/rdf-schema#comment", content = "Represents the peer", dataTypeUri = "")
})
public interface Peer
    extends Person, Thing
{
