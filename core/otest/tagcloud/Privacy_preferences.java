 ...
 * Class URI: <code>http://www.semanticweb.org/vfayet/ontologies/2013/5/untitled-ontology-36#Privacy_preferences</code>
 * 
 * <br>
 * OWLComment: Represents the privacy preferences of a user
 * 
 */
@OwlClass(uri = "http://www.semanticweb.org/vfayet/ontologies/2013/5/untitled-ontology-36#Privacy_preferences")
@OwlSubclassOf({
...
@OwlAnnotations({
    @OwlAnnotation(uri = "http://www.w3.org/2000/01/rdf-schema#comment", content = "Represents the privacy preferences of a user", dataTypeUri = "")
})
public interface Privacy_preferences
    extends Preferences, Thing
{
