 ...
 * Class URI: <code>http://www.semanticweb.org/vfayet/ontologies/2013/5/untitled-ontology-36#Preferences</code>
 * 
 * <br>
 * OWLComment: NOTE!!! ADD DATE AS A PROPERTY TO ENSURE DYNAMIC UPDATE OF THE USER PROFILE
 * <br>
 * OWLComment: It includes the interests and likes
 * <br>
 * OWLComment: Represents the preferences of a user
 * 
 */
@OwlClass(uri = "http://www.semanticweb.org/vfayet/ontologies/2013/5/untitled-ontology-36#Preferences")
@OwlSubclassOf({
    @OwlClass(uri = "http://www.w3.org/2002/07/owl#Thing")
})
@OwlAnnotations({
    @OwlAnnotation(uri = "http://www.w3.org/2000/01/rdf-schema#comment", content = "NOTE!!! ADD DATE AS A PROPERTY TO ENSURE DYNAMIC UPDATE OF THE USER PROFILE", dataTypeUri = ""),
    @OwlAnnotation(uri = "http://www.w3.org/2000/01/rdf-schema#comment", content = "It includes the interests and likes", dataTypeUri = ""),
    @OwlAnnotation(uri = "http://www.w3.org/2000/01/rdf-schema#comment", content = "Represents the preferences of a user", dataTypeUri = "")
})
